...
class LaporanPengembalian extends StatefulWidget {
  ...
  LaporanPengembalian({required this.viewModel, required this.salesmanData});
...
class _LaporanPengembalianState extends State<LaporanPengembalian> {
  List<TransaksiPengembalian> data = [];
  ...
  Future<void> _fetchBarangs() async {
    try {
      await widget.viewModel.getLaporanPengembalian(
          widget.salesmanData['ID_SALES'], dateController.text);
      setState(() {
        data = List.from(widget.viewModel.laporanPengembalian);
      });
    } catch (error) {
      setState(() {
...
// Membuat objek DateTime dari bagian-bagian tanggal
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Lihat Data Pengembalian Barang',
        ...
        children: [
          ...
          Expanded(
            child: data.isEmpty || data == null
                ? Center(
                    child: Text(
                      'Tidak ada pengembalian di tanggal ini',
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      List<TransaksiPengembalian> transaksisSama = [];
